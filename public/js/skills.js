const toggleClass = (identifier, removeClass, addClass) => {
...
$(document).ready(() => {
  ...
  $('#js-button').click(() => {
    $('#js-div').toggle();
    toggleClass('#js-button div span', 'glyphicon-triangle-bottom', 'glyphicon-triangle-top');
  ...
  $('#java-button').click(() => {
    $('#java-div').toggle();
    toggleClass('#java-button div span', 'glyphicon-triangle-bottom', 'glyphicon-triangle-top');
  ...
  $('#web-button').click(() => {
    $('#web-div').toggle();
    toggleClass('#web-button div span', 'glyphicon-triangle-bottom', 'glyphicon-triangle-top');
    toggleClass('#web-button', 'group-button-inactive', 'group-button-active');
  });
});

// const toggleCSS = (identifier, property, removeCSS, addCSS) => {
